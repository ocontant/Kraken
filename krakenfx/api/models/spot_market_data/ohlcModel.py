from sqlalchemy import Column, Integer, Float, String, BigInteger, ForeignKey, Index, create_engine
...
class OHLCData(Base):
    ...
    def __init__(self, asset_pair_id, time, open, high, low, close, vwap, volume, count):
