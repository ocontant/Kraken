...
from krakenfx.services.schemas.spot_market_data.assetsSchemas import (
    SchemasAssets,
    SchemasAssetsReturn,
    SchemasResponse
)
...
async def get_Time():
    ...
    async with httpx.AsyncClient() as client:
        ...
        assetsResponse = SchemasResponse(**response.json())
        await check_schemasResponse_empty(assetsResponse)
        assets: SchemasAssetsReturn = assetsResponse.result
        return assets
