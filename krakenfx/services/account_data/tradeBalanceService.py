# my_project/services/tradebalance_service.py
import httpx
import time
import urllib.parse
import json
...
from krakenfx.services.account_data.schemas.tradebalanceSchemas import SchemasTradeBalanceResponse, SchemasTradeBalance
